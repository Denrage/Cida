...
namespace Module.HorribleSubs.Cida
{
    public class Module : IModule
    {
        ...
        public async Task Load(IDatabaseConnector databaseConnector, IFtpClient ftpClient, Directory moduleDirectory)
        {
            ...
            this.GrpcServices = new[] { HorribleSubsService.BindService(new HorribleSubsImplementation(this.searchService, this.downloadService, this.GetContext, ftpClient, downloadDirectory)), };
            Console.WriteLine("Loaded HorribleSubs");
        }

        private HorribleSubsDbContext GetContext() => new HorribleSubsDbContext(this.connectionString);
        ...
        public class HorribleSubsImplementation : HorribleSubsService.HorribleSubsServiceBase
        {
            ...
            public HorribleSubsImplementation(SearchService searchService, DownloadService downloadService, Func<HorribleSubsDbContext> getContext, IFtpClient ftpClient, Directory downloadDirectory)
            {
