...
namespace Cida.Client.Avalonia.ViewModels.Launcher
{
    public class ModuleSelectScreenViewModel : ViewModelBase
    {
        ...
        public async Task Load()
        {
            ...
            var modules = new[] { 
                AvaloniaModule.Unpacked(@"D:\Repos\Cida\src\Projects\Modules\IrcAnime\Clients\Module.IrcAnime.Avalonia\bin\Debug\net6.0").Module, 
                AvaloniaModule.Unpacked(@"D:\Repos\Cida\src\Projects\Modules\Crunchyroll\Clients\Module.Crunchyroll.Avalonia\bin\Debug\net6.0").Module, 
                AvaloniaModule.Unpacked(@"D:\Repos\Cida\src\Projects\Modules\AnimeSchedule\Clients\Module.AnimeSchedule.Avalonia\bin\Debug\net6.0").Module };
